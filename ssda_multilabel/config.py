...
DEFAULT_OUTPUT_DIR = "save/ssda_multilabel"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--drug_id_col", default="drug_id")
    p.add_argument("--response_col", default="response")
    ...
    p.add_argument("--latent_output_dir", default=DEFAULT_OUTPUT_DIR)
